...
#' @importFrom data.table data.table as.data.table fread setnames := .SD .N .I .GRP .BY .EACHI .NGRP melt setcolorder copy
#' @importFrom ggplot2 ggplot aes geom_point geom_tile labs theme theme_minimal coord_fixed scale_colour_manual scale_fill_gradient2 scale_size_continuous element_blank .data
